...
import { collection, onSnapshot, doc, updateDoc, serverTimestamp, onSnapshot as onDocSnapshot } from "firebase/firestore";
...
export default function Presentes() {
  ...
  const reservar = async (p) => {
    ...
    try {
      ...
      // 🔹 Escuta apenas a transação criada
          ...
          <div key={p.id} style={{
            ...
            {p.imagemUrl && (
              <div style={{
                ...
                <img src={p.imagemUrl} alt={p.nome} style={{ maxWidth: "100%", maxHeight: "100%", objectFit: "contain" }}/>
              </div>
            )}
          ...
          <div style={{
            ...
            {paymentConfirmed ? (
              ...
              <>
                ...
                <img src={qrCode} alt="QR Code Pagamento" style={{ marginTop: "1rem", width: "250px", height: "250px", borderRadius: "10px" }} />
                <p style={{ marginTop: "1rem" }}>
                  Escaneie com o app do banco ou copie o código abaixo 👇
                </p>
                {copyCode && (
                  <div style={{ marginTop: "1rem" }}>
                    <input type="text" readOnly value={copyCode} style={{
                      width: "100%", padding: "8px", borderRadius: 6, border: "1px solid #ccc", textAlign: "center", fontSize: "12px"
                    }}/>
                    <button onClick={copiarQRCode} style={{
                      marginTop: 8, backgroundColor: "#2e7d32", color: "#fff", padding: "6px 12px", borderRadius: 6, cursor: "pointer", fontSize: "14px"
